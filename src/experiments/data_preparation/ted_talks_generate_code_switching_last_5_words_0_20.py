...
if __name__ == "__main__":
    ...
    out_path = Path(__file__).parent.joinpath("../../../data/ted_talks_code_switching_last_3_words.jsonl")
    ...
    for language_code in translate_codes:
        ...
        generate_code_switching_last_n_words(df, language_code, out_path, n=5)
